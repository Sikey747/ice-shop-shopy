        ...
        var t = {
                ...
                853: function (t, e, i) {
                    ...
                    function N(t) {
                        return "html" === O(t)
                            ? t
                            : t.assignedSlot || t.parentNode || (P(t) ? t.host : null) || K(t);
                    }
                    function U(t) {
                        return T(t) && "fixed" !== W(t).position ? t.offsetParent : null;
                    }
                    function X(t) {
                        for (var e = x(t), i = U(t); i && F(i) && "static" === W(i).position; )
                            i = U(i);
                        return i &&
                        ...
                        var o =
                                "clippingParents" === e
                                    ? (function (t) {
                                          var e = ht(N(t)),
                                              i =
                                                  ["absolute", "fixed"].indexOf(W(t).position) >=
                                                      0 && T(t)
                                                      ? X(t)
                                                      : t;
                                          return C(i)
                                    ...
                                    this._options.alwaysOpen ||
                                        this._items.map(function (t) {
                                            ...
                                            t !== o &&
                                                ...
                                                (t.active = !1),
                                                t.iconEl &&
                                                    t.iconEl.classList.remove("rotate-180"));
                                        }),
