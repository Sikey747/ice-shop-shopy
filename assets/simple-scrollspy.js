        ...
        218: (t, o, e) => {
          ...
          class s {
            constructor(t, o = {}) {
              if (!t)
                throw new Error(
                  "Your navigation query selector is the first argument.",
                );
              if ("object" != typeof o)
                throw new Error(
                  "The second argument must be an instance of an Object.",
                );
              (o.smoothScroll =
            ...
            setActive(t) {
              t.classList.contains(this.options.activeClass) ||
                ...
                "function" == typeof this.options.onActive &&
                  this.options.onActive(t));
            }
